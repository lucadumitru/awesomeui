(() => {
    ...
    const cardsSection03Parent = document.querySelector(".section-03__cards");
    const cardsSection03 = document.querySelectorAll(".section-03__card");
    const observer = new ResizeObserver((entries => {
        for (let entry of entries) {
            const {width, height} = entry.contentRect;
            if (width < 768) {
                if (cardsSection03.length > 3) cardsSection03Parent.style.flexWrap = "nowrap";
                cardsSection03Parent.style.width = 333 * `${cardsSection03.length}` + "px";
            } else if (width > 768) {
                cardsSection03Parent.style.width = "auto";
                if (cardsSection03.length > 3) cardsSection03Parent.style.flexWrap = "wrap";
            }
            if (width < 479) cardsSection03Parent.style.width = 166 * `${cardsSection03.length}` + "px"; else if (width > 479 && width < 768) cardsSection03Parent.style.width = 333 * `${cardsSection03.length}` + "px";
        }
    }));
